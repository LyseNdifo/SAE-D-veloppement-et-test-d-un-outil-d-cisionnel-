...
#######---------------------------------------------PARTIE HAOMING et LYSE----------------------------------------#######################



### VOIR PARTIE COMMUNE LYSE ET HAOMING SUR LA PREPARATION DES DONNEES A LA MODELISATION DANS LE FICHIER QUI CONTIENT LES 
###  CODES AVEC LA POO


#Analyse de la correlation 

#La remise semble être positivement corrélée à l'annulation des abonnements, avec une corrélation significative de 0.7. 
#Cela suggère que les clients ayant bénéficié de remises ont tendance à avoir une probabilité plus élevée d'annuler leur 
#abonnement. D'autre part, une corrélation de 0.61 a été observée entre le pourcentage du plan basique et le nombre de 
#sessions, ce qui suggère que les clients utilisant davantage le plan basique ont tendance à participer à un plus grand 
#nombre de sessions.